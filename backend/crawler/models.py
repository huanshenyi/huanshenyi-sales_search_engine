...
class CrawlerData(models.Model):
    ...
    occupation = models.CharField(max_length=50, null=False, default="営業", help_text="職種", verbose_name="職種")
    annual_income_min = models.CharField(max_length=10, null=True, default=0, help_text="最低提示年収", verbose_name="最低提示年収")
    annual_income_max = models.CharField(max_length=10, null=True, default=0, help_text="最高提示年収", verbose_name="最高提示年収")
